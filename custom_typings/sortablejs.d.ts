...
declare namespace Sortablejs {
    interface SortableOptions {
        ...
        disabled?: boolean;
        store?: {
            get: (sortable: SortableStatic) => any[];
            set: (sortable: SortableStatic) => any;
        };
        animation?: number;
        handle?: string;
        filter?: any;
    ...
    interface SortableStatic {
         ...
         * @returns {Sortable}
         */
        create(element: any, options: SortableOptions): SortableStatic;
...
declare let Sortable: Sortablejs.SortableStatic;
